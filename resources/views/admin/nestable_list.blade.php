        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <div class="panel panel-warning">
                    ...
                    <div class="panel-body">
                        <div class="" id="sortable1" style="margin-right: 17px;">
                            <div class="col-sm-4">
                    ...
                    <div class="panel-body">
                        <div class="col-sm-6">
                            <ul id="sortable2">
                                ...
                                <li>
                                    ...
                                    <ul class="js-inner-connected" id="inner">
                                        <li style="background-color: #67C5DF; color: #fff"><span >|| </span>Inner item 3</li>
                                        <li style="background-color: #67C5DF; color: #fff"><span >|| </span>Inner item 4</li>
                                    </ul>
                                </li>
                        ...
                        <div class="col-sm-6">
                            <ul id="sortable3" class="connected">
                                <li><span></span>Item 1</li>
                                <li>
                                    <div class="mb1"><span></span>Item 2</div>
                                    <ul class="js-inner-connected" id="inner">
                                        <li style="background-color: #67C5DF; color: #fff"><span>|| </span>Inner item 1</li>
                                        <li style="background-color: #67C5DF; color: #fff"><span>|| </span>Inner item 2</li>
                                    </ul>
                                </li>
                                <li><span></span>Item 3</li>
