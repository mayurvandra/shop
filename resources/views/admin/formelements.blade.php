...
@section('content')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="rocket" data-size="18" data-loop="true" data-c="#fff" data-hc="white"></i>
                            Auto Grow
                        </h3>
                                <span class="pull-right clickable">
                                    <i class="glyphicon glyphicon-chevron-up"></i>
                    ...
                    <div class="panel-body">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <textarea placeholder="Write something here..." class="span3" data-autogrow rows="3"></textarea>
                            </div>
                            <!-- /.input group --> </div>
                        <div class="form-group">
                            <label>
                            ...
                            <div class="input-group">
                                <textarea  placeholder="Write something here..." class="span3 auto2 form-control" data-autogrow rows="3" cols="80" style="padding: 45px;"></textarea>
                            </div>
                            <!-- /.input group --> </div>
                        <div class="form-group">
                            <label>
    ...
    @section('footer_scripts')
            ...
            <!-- InputMask --> <script src="{{ asset('assets/vendors/moment/js/moment.min.js') }}" ></script>
