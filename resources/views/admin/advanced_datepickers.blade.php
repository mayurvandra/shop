                                ...
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input class="form-control flatpickr" placeholder="Min date: Today" data-mindate="today" data-maxdate='2016-12-15'>
                                        </div>
                                    </div>
                                    <!-- /.input group -->
                                    <!-- /.form group -->
                                            ...
                                            <p class="flatpickr input-group" data-wrap="true" data-clickOpens="false">
                                                <input class="form-control" placeholder="Pick date" data-input>
                                                    <span class="input-group-addon add-on">
                                                        <a class="input-btn" data-toggle><i class="fa fa-calendar"></i></a>
                                                    </span>
                                                    <span class="input-group-addon add-on">
                                                        <a class="input-btn" data-clear><i class="fa fa-remove"></i></a>
                                                    </span>
                            ...
                            <div class="panel-body">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="example"><div class="example--label"></div><div class="example-content"><div class="list-inline"><div><div id="custom-cells"></div></div><div id="custom-cells-events"><strong></strong></div></div>
                                                <!-- /.input group -->
                                            </div>
                                            <!-- /.form group -->
                                        </div>
