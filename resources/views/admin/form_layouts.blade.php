                                            ...
                                            <div class="panel-body">
                                                <form action="#" class="form-horizontal">
                                                    ...
                                                    <div class="form-body">
                                                        ...
                                                        <div class="form-group">
                                                            <label for="inputnumber" class="col-md-3 control-label">Phone Number
                                                            </label>
                                                            <div class="col-md-9">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="panel panel-success">
                                                    ...
                                                    <div class="panel-body">
                                                        <form class="form-inline" role="form">
                                                            ...
                                                            <div class="checkbox mar-left5">
                                                                <label>
                                                                    <input type="checkbox" style="margin-right: 7px; margin-top: 5px;">Remember me</label>
                                                            </div>
                                                                </div>
                                                            <div class="co-md-6">
                                                ...
                                                <div class="panel panel-warning">
                                                    <div class="panel-heading">
                                                        <h3 class="panel-title">
                                                            <i class="livicon" data-name="doc-portrait" data-c="#fff" data-hc="#fff" data-size="18" data-loop="true"></i>
                                                            Grid sizing of Inputs, Textareas,Select Boxes
                                                        </h3>
                                                        <span class="pull-right">
                                                    <i class="fa fa-fw fa-chevron-up clickable"></i>
                                                    <i class="fa fa-fw fa-times removepanel clickable"></i>
