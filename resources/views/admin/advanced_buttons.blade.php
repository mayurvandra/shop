                    ...
                    <div class="panel-body">
                        <div class="text-left">
                            <ul class="list-inline">
                                ...
                                <li>
                                    <a href="#" class="button button-rounded button-wrning">Button</a>
                                </li>
                                <li>
                                    <a href="#" class="button button-rounded button-danger">Button</a>
                                </li>
                            ...
                            <ul>
                                <li>
                                            <span class="button-wrap">
                                                <a href="#" class="button button-circle button-large btn-wht">Button</a>
                                            </span>
                                </li>
                                <li>
                                            <span class="button-wrap">
                ...
                <div class="panel panel-danger">
                    ...
                    <div class="panel-body">
                        <div class="flatbuttons_small1">
                            ...
                            <br/>
                            <a href="#"
                               class="button button-block button-rounded button-warning button-large">Button</a>
                            <br/>
                            <a href="#"
                               class="button button-block button-rounded button-danger button-large">Button</a>
                            <br/>
                            ...
                            <ul>
                                <li>
                                    <div class="button-group">
                                        <button type="button" class="button glow">Option 1</button>
                                        <button type="button" class="button glow">Option 2</button>
                                        <button type="button" class="button glow">Option 3</button>
                                    </div>
                                </li>
                                <li>
                                    <div class="button-group">
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-xs-6 col-md-6">
                                ...
                                <a href="#" class="btn btn-primary btn-sm btn-responsive" role="button">
                                    <i class="livicon" data-name="comment" data-size="16" data-loop="true" data-c="#fff"
                                       data-hc="white"></i>
                                    <br/>
                                    Comments
                                </a>
                            ...
                            <div class="col-xs-6 col-md-6">
                                ...
                                <a href="#" class="btn btn-info btn-sm btn-responsive" role="button">
                                    <i class="livicon" data-name="doc-portait" data-size="16" data-loop="true" data-c="#fff"
                                       data-hc="white"></i>
                                    <br/>
                                    Notes
                                </a>
                            ...
                            <div class="col-md-12 text-center">
                                <div class="ui-group-buttons">
                                    <a href="#" class="btn btn-success" role="button">
                                        <span class="livicon" data-name="thumbs-up" data-size="16" data-loop="true" data-c="#fff"
                                              data-hc="white"></span>
                                    </a>
                                    <div class="or"></div>
                                    <a href="#" class="btn btn-danger" role="button">
                                        <span class="livicon" data-name="thumbs-down" data-size="16" data-loop="true" data-c="#fff"
                                              data-hc="white"></span>
                                    </a>
                                </div>
                                <div class="ui-group-buttons">
                                    <a href="#" class="btn btn-success" role="button">
                                        <span class="livicon" data-name="save" data-size="16" data-loop="true" data-c="#fff"
                                              data-hc="white"></span>
                                    </a>
                                    <div class="or"></div>
                                    <a href="#" class="btn btn-danger" role="button">
                                        <span class="livicon" data-name="trash" data-size="16" data-loop="true" data-c="#fff"
                                              data-hc="white"></span>
                                    </a>
                                </div>
                                <br/>
                                ...
                                <div class="ui-group-buttons">
                                    <a href="#" class="btn btn-success" role="button" >
                                        <i style="margin-top: 10px;"><span class="livicon" data-name="check" data-size="18" data-loop="true" data-c="#fff"
                                              data-hc="white" style="position: relative; top:4px; right:4px;"></span></i>
                                        Sign Up
                                    </a>
                                    <div class="or"></div>
                                    <a href="#" class="btn btn-default" role="button">
                                        <span class="livicon" data-name="remove" data-size="18" data-loop="true" data-c="#000"
                                              data-hc="black" style="position: relative; top:4px; right:4px;"></span>
                                        Reset
                                    </a>
                                </div>
                                <br/>
                    ...
                    <div class="panel-body icon-buttons">
                            ...
                            <div class="col-lg-6 col-md-6 col-xs-6 col-sm-6">
                                ...
                                <a class="btn btn-success btn-labeled" role="button">
                                    ...
                                    <span class="label-text">Info Web</span>
                                </a>
                            </div>
