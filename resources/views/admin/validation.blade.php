                ...
                <div class="panel panel-primary">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="checked-on" data-size="16" data-loop="true" data-c="#fff"
                               data-hc="white"></i>
                                        ...
                                        <div class="modal-body">
                                            <form role="form" id="form-validation1" action="#" method="patch">
                                                ...
                                                <div class="row marginTop">
                                                    ...
                                                    <div class="col-xs-6 col-md-6">
                                                        <a class="btn btn-success btn-block btn-md btn-responsive" data-dismiss="modal">Sign In</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
