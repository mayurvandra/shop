                ...
                <div class="panel panel-success" id="hidepanel6">
                    ...
                    <div class="panel-body">
                        <form action="#" method="patch">
                            ...
                            <div class="form-group">
                                <label style="margin-right: 10px;">Inline Checkboxes</label>
                            ...
                            <div class="form-group">
                                <label style="margin-right: 10px;">Inline Radio Buttons</label>
                            ...
                            <input href="#" type="submit" class="btn btn-success btn-md btn-responsive" role="button">
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="panel panel-danger" id="hidepanel4">
                    <div class="panel-heading">
                        <h3 class="panel-title"><i class="livicon" data-name="checked-on" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                            Validation states
                        </h3>
                                <span class="pull-right">
                                    <i class="glyphicon glyphicon-chevron-up clickable"></i>
            ...
            <div class="col-md-6">
                <div class="panel panel-default" id="hidepanel3">
                    <div class="panel-heading">
                        <h3 class="panel-title">
                            <i class="livicon" data-name="ban" data-size="16" data-loop="true" data-c="#fff" data-hc="white"></i>
                            Disabled fieldsets
                        </h3>
                                <span class="pull-right">
                                    <i class="glyphicon glyphicon-chevron-up clickable"></i>
