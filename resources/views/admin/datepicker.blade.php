                            ...
                            <div class="panel-body">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control date"  id="datetime1"/>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control date" id="datetime3"/>
                                    </div>
                                    <!-- /.input group -->
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control date" id="datetime4"/>
                                    </div>
                                    <!-- /.input group -->
                                </div>
